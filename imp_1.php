...
if (!$zero_results)
{
	...
	switch (strlen($folio))
	{
		case 1:{$folio = "DO10000".$folio; break;}
		case 2:{$folio = "DO1000".$folio; break;}
		case 3:{$folio = "DO100".$folio; break;}
		case 4:{$folio = "DO10".$folio; break;}
		case 5:{$folio = "DO1".$folio; break;}
	}
}
else
{
...
<br><br><br>
<tr><table border="0" style="width:760px"><tr><td><label><p class="textito">FIRMA DO1</p></label></td></tr></table></tr>
</table>
<br><br><br>
<div align="center">
<p class="texto_foot">
Escuela Secundaria General 120 "Rosario Castellanos", Calzada Maestro Rural No. 57 Col. Santo Tomás, Deleg. Miguel Hidalgo<br>
C.P. 11340, Tel. 53961928, Correo Electrónico cses.do1@sepdf.gob.mx. Visite las páginas www.sep.gob.mx y www.sepdf.gob.mx
</p>
</div>
