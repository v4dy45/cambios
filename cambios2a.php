...
if (isset($_POST['guardar']))
{
	...
	else //if not
	{
		...
		if ($_SESSION['aux'] == 0)
		{
			...
			if ($cct_org == "NULL")
			{$sql = "INSERT INTO t_alumnos VALUES ('".$curp_a."','".$nom."','".$app."','".$apm."',NULL,'".$cct_ou."',DEFAULT,CURDATE(),'SEGUNDO','".$_SESSION['user']."',0,NULL,NULL,0,'".$temp."',".$temp_aux.")";}
			else
			{$sql = "INSERT INTO t_alumnos VALUES ('".$curp_a."','".$nom."','".$app."','".$apm."','".$cct_org."','".$cct_ou."',DEFAULT,CURDATE(),'SEGUNDO','".$_SESSION['user']."',0,NULL,NULL,0,'".$temp."',".$temp_aux.")";}
			require ('consulta.php');
...
<br><br>
<fieldset>
<legend><?php echo $_SESSION['user']; ?> - Inscripción <u>SEGUNDO</u> Grado <u>SIN CURP</u></legend>
<form action="cambios2a.php" method="post" name="cambios2a" id="cambios2a">
<div align = "left">
...
<form method="post" action="cambios2a.php">
