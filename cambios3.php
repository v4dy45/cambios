...
if (isset($_POST['guardar']))
{
	...
	else //if not
	{
		...
		if ($_SESSION['aux'] == 0)
		{
			...
			if ($cct_org == "NULL")
			{$sql = "INSERT INTO t_alumnos VALUES ('".$curp."','".$nom."','".$app."','".$apm."',NULL,'".$cct_ou."',DEFAULT,CURDATE(),'TERCERO','".$_SESSION['user']."',0,NULL,NULL,0,'".$temp."',".$temp_aux.")";}
			else
			{$sql = "INSERT INTO t_alumnos VALUES ('".$curp."','".$nom."','".$app."','".$apm."','".$cct_org."','".$cct_ou."',DEFAULT,CURDATE(),'TERCERO','".$_SESSION['user']."',0,NULL,NULL,0,'".$temp."',".$temp_aux.")";}
			require ('consulta.php');
...
<br><br>
<fieldset>
<legend><?php echo $_SESSION['user']; ?> - Inscripción <u>TERCER</u> Grado</legend>
<form action="cambios3.php" method="post" name="cambios3" id="cambios3">
<div align = "left">
<a class="texto" href="cambios3a.php">ALUMNO SIN CURP</a>
...
<form method="post" action="cambios3.php">
