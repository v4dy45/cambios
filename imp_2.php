...
if (!$zero_results)
{
	...
	switch (strlen($folio))
	{
		case 1:{$folio = "DO20000".$folio; break;}
		case 2:{$folio = "DO2000".$folio; break;}
		case 3:{$folio = "DO200".$folio; break;}
		case 4:{$folio = "DO20".$folio; break;}
		case 5:{$folio = "DO2".$folio; break;}
	}
}
else
{
...
<br><br><br>
<tr><table border="0" style="width:760px"><tr><td><label><p class="textito">FIRMA DO2</p></label></td></tr></table></tr>
</table>
<br><br><br>
<div align="center">
<p class="texto_foot">
Av. Schumann y Constantino, Col. Vallejo, Deleg. Gustavo A. Madero, C.P. 07870, Tel. 51192541<br>
Correo Electrónico cses.do2@sepdf.gob.mx Visite las páginas www.sep.gob.mx y www.sepdf.gob.mx
</p>
</div>
