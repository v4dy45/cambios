...
if (!$zero_results)
{
	...
	switch (strlen($folio))
	{
		case 1:{$folio = "DO40000".$folio; break;}
		case 2:{$folio = "DO4000".$folio; break;}
		case 3:{$folio = "DO400".$folio; break;}
		case 4:{$folio = "DO40".$folio; break;}
		case 5:{$folio = "DO4".$folio; break;}
	}
}
else
{
...
<br><br><br>
<tr><table border="0" style="width:760px"><tr><td><label><p class="textito">FIRMA DO4</p></label></td></tr></table></tr>
</table>
<br><br><br>
<div align="center">
<p class="texto_foot">
Arcos de Belén No. 23, Piso 5, Col. Obrera, Deleg. Cuauhtémoc, C.P: 06800<br>
Correo Electrónico andres.canoa@sepdf.gob.mx Visite las páginas www.sep.gob.mx y www.sepdf.gob.mx
</p>
</div>
