...
if (!$zero_results)
{
	...
	switch (strlen($folio))
	{
		case 1:{$folio = "DO60000".$folio; break;}
		case 2:{$folio = "DO6000".$folio; break;}
		case 3:{$folio = "DO600".$folio; break;}
		case 4:{$folio = "DO60".$folio; break;}
		case 5:{$folio = "DO6".$folio; break;}
	}
}
else
{
...
<br><br><br>
<tr><table border="0" style="width:760px"><tr><td><label><p class="textito">FIRMA DO6</p></label></td></tr></table></tr>
</table>
<br><br><br>
<div align="center">
<p class="texto_foot">
Anillo Periférico 7650, Col. Granjas Coapa, Unidad Habitacional Cuemanco, Deleg. Tlalpan, C.P. 14330, Tel. 56034164<br>
Correo Electrónico cses.do5@sepdf.gob.mx Visite las páginas www.sep.gob.mx y www.sepdf.gob.mx
</p>
</div>
