...
if (!$zero_results)
{
	...
	switch (strlen($folio))
	{
		case 1:{$folio = "CSES0000".$folio; break;}
		case 2:{$folio = "CSES000".$folio; break;}
		case 3:{$folio = "CSES00".$folio; break;}
		case 4:{$folio = "CSES0".$folio; break;}
		case 5:{$folio = "CSES".$folio; break;}
	}
}
else
{
...
<br><br><br>
<tr><table border="0" style="width:760px"><tr><td><label><p class="textito">FIRMA CSES</p></label></td></tr></table></tr>
</table>
<br><br><br>
<div align="center">
<p class="texto_foot">
Arcos de Belén No.23 Col. Centro, Deleg. Cuauhtémoc<br>
C.P. 06070. Visite las páginas www.sep.gob.mx y www.sepdf.gob.mx
</p>
</div>
